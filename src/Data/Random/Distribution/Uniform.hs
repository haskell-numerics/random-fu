...
instance Distribution Uniform Int8    where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Int16   where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Int32   where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Int64   where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Int     where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Integer where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Word8   where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Word16  where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Word32  where getDistFrom = computeIntegralUniformDist
instance Distribution Uniform Word64  where getDistFrom = computeIntegralUniformDist
instance (Distribution Uniform a, Distribution Uniform b) => Distribution Uniform (a,b) where
    getDistFrom s (Uniform (a1,b1) (a2,b2)) = do
        a <- getDistFrom s (Uniform a1 a2)
        b <- getDistFrom s (Uniform b1 b2)
        return (a,b)
...
instance Distribution Uniform Float  where getDistFrom = computeRealFloatUniformDist
instance Distribution Uniform Double where getDistFrom = computeRealFloatUniformDist
